      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              ...
              <form className="flex gap-2 max-w-sm" onSubmit={(e) => e.preventDefault()}>
                ...
                />
                <button type="submit" className="bg-white text-black px-4 py-2 rounded-xl font-bold hover:bg-gray-200 transition-colors shrink-0">
                  <ArrowRight size={18} />
                </button>
              </form>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-400">
              ...
              <li><Link to="/blog/sales-automation" className="hover:text-saas-neon transition-colors">Changelog</Link></li>
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-gray-800 gap-4">
          ...
          <div className="flex items-center gap-4 text-gray-500">
            <a href="https://danielsiroportfolio.vercel.app/" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">
              <Globe size={20} />
            </a>
            <a href="https://twitter.com" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">
              <Twitter size={20} />
            </a>
            <a href="https://github.com/wannabes48" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">
              <Github size={20} />
            </a>
